        ...
        body: Center(
          child: Container(
            ...
            child:
              ...
              SizedBox(height: 11),
              Text(
                "Welcome to MyChat, Please sign in to continue using our app.",
                style: tTextStyle.copyWith(fontSize: 12),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: 
                    Text("Sign up",style: tTextStyle.copyWith(fontSize: 12,fontWeight: bold, color: Colors.blue)
                    )
                  )
                ],
              ),
