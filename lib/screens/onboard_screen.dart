    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          body: "As simple as it should be!",
          image: Image.asset(
            'img/slide1.png',
            width: 400,
          ),
        ...
        PageViewModel(
          ...
          body: "Ensure your privacy and confidentiality",
          image: Image.asset('img/i.png', width: 400),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Connect yourself with others",
          body: "Make new friends around the world!",
          image: Image.asset('img/slide3.png', width: 400),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Start your journey with us!",
          body: "Explore more and learn more about us!",
